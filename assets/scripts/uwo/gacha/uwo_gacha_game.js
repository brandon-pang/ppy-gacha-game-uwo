...
lib.ssMetadata = [
		{name:"uwo_gacha_game_atlas_", frames: [[762,2272,760,500],[762,1770,760,500],[0,1518,1920,250],[0,0,1420,850],[0,852,1420,664],[1778,926,52,52],[1763,416,186,168],[1763,246,186,168],[1778,586,186,168],[1778,756,186,168],[1524,1116,51,50],[1524,1168,51,50],[402,2899,321,400],[1524,1220,44,44],[0,3341,760,8],[725,2899,25,26],[1832,926,153,176],[1832,1104,153,176],[1422,1282,153,176],[1577,1116,153,176],[1732,1282,153,176],[0,1770,760,625],[1754,0,168,244],[1422,1116,100,130],[1577,1294,129,38],[1422,282,339,215],[1422,499,339,215],[1361,3276,179,70],[0,2899,400,400],[1422,1248,100,27],[1422,1460,499,44],[725,3276,634,63],[0,2397,760,500],[1422,858,354,140],[1422,716,354,140],[1422,1000,408,114],[1422,0,330,280],[762,2774,760,500]]}
];
...
(lib.beachempty = function() {
	this.spriteSheet = ss["uwo_gacha_game_atlas_"];
	this.gotoAndStop(0);
...
(lib.mc_title_text = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("Treasure Cove", "29px 'Rasa SemiBold'", "#FFFFFF");
...
}).prototype = getMCSymbolPrototype(lib.mc_title_text, new cjs.Rectangle(0,0,306,39.3), null);
...
(lib.btn_radio = function(mode,startPosition,loop) {
	...
	this.no_text.setTransform(20.6,1);
	...
	this.shape.setTransform(7,10.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(240,179,25,0.008)").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_1.setTransform(7,10.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(240,179,25,0.063)").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_2.setTransform(7,10.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(240,179,25,0.216)").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_3.setTransform(7,10.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(240,179,25,0.514)").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_4.setTransform(7,10.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F0B319").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_5.setTransform(7,10.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F7D889").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_6.setTransform(7,10.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FCEFCD").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_7.setTransform(7,10.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FEFAF0").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_8.setTransform(7,10.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFEFD").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_9.setTransform(7,10.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_10.setTransform(7,10.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FBECC6").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_11.setTransform(7,10.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#F8D98C").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_12.setTransform(7,10.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#F4C653").s().p("AgcAcQgLgMAAgQQAAgQALgMQANgLAPAAQAQAAAMALQAMAMAAAQQAAAQgMAMQgMAMgQAAQgPAAgNgMg");
	this.shape_13.setTransform(7,10.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},13).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_5}]},1).wait(1));

	// Layer_1
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#FFFFFF").ss(2,1,1).p("ABGAAQAAAcgVAVQgUAVgdAAQgcAAgVgVQgUgVAAgcQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcg");
	this.shape_14.setTransform(7,10.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#FFFEFD").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_15.setTransform(7,10.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#FEFAF0").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_16.setTransform(7,10.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#FCEFCD").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_17.setTransform(7,10.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#F7D889").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_18.setTransform(7,10.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#F0B319").ss(2,1,1).p("ABGAAQAAAcgVAVQgUAVgdAAQgcAAgVgVQgUgVAAgcQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcg");
	this.shape_19.setTransform(7,10.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#FBECC6").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_20.setTransform(7,10.5);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#F8D98C").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_21.setTransform(7,10.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#F4C653").ss(2,1,1).p("AhFAAQAAgcAUgVQAVgUAcAAQAdAAAUAUQAVAVAAAcQAAAdgVAUQgUAVgdAAQgcAAgVgVQgUgUAAgdg");
	this.shape_22.setTransform(7,10.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14}]}).to({state:[{t:this.shape_14}]},7).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_19}]},7).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[{t:this.shape_19}]},1).wait(1));
...
(lib.btn_new_chest = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(25.9,46.6);
...
(lib.mc_title = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#5E320A").s().p("");
	this.shape.setTransform(272.2,25.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#5E320A").s().p("");
	this.shape_1.setTransform(252.7,25.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#5E320A").s().p("");
	this.shape_2.setTransform(231.9,25.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#5E320A").s().p("");
	this.shape_3.setTransform(207.6,21.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#5E320A").s().p("");
	this.shape_4.setTransform(176.4,25.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#5E320A").s().p("");
	this.shape_5.setTransform(159.2,25.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#5E320A").s().p("");
	this.shape_6.setTransform(139.6,25.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#5E320A").s().p("");
	this.shape_7.setTransform(120.4,25.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#5E320A").s().p("");
	this.shape_8.setTransform(103.2,25.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#5E320A").s().p("");
	this.shape_9.setTransform(86,25.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#5E320A").s().p("");
	this.shape_10.setTransform(61.8,20.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.mc_title, new cjs.Rectangle(0,0,327.5,47.9), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_sc1_bg, new cjs.Rectangle(0,0,760,625), null);
...
(lib.mc_paper_logo = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-63,-63,0.313,0.313);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mc_paper_logo, new cjs.Rectangle(-63,-63,125,125), null);
...
(lib.Mc_balance_indicate = function(mode,startPosition,loop) {
	...
	this.txt_balance.setTransform(30.8,4.7);
	...
	this.txt_total_balance.setTransform(101.3,3.7);
...
(lib.mc_page_normal = function(mode,startPosition,loop) {
	...
	this.shape_1.setTransform(3.5,6.2);
...
(lib.Btn_result_back = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhAAAIBkhjIAdAdIhIBGIBIBIIgdAcg");
	this.shape.setTransform(35.5,36.5,1.307,1.292);
...
(lib.Btn_inventory = function(mode,startPosition,loop) {
	...
	this.txt.parent = this;
	this.txt.setTransform(112.8,12);
...
(lib.Mc_keyBox = function(mode,startPosition,loop) {
	...
	this.txt_top_title.setTransform(84.3,3.8);
	...
	this.txt_top_key.setTransform(102.7,84);
...
p.nominalBounds = new cjs.Rectangle(0,1.8,168,259.3);
...
(lib.Mc_confirm_info = function(mode,startPosition,loop) {
	...
	this.txt_balance.parent = this;
	this.txt_balance.setTransform(94.3,89);
	...
	this.txt_keys.setTransform(94.3,45);
	...
	this.shape.setTransform(94.5,97.7);
	...
	this.txt_balance_1.setTransform(41.8,118);
	...
	this.txt_total_balance.parent = this;
	this.txt_total_balance.setTransform(125.4,117);
...
(lib.Mc_buyKeySelect3 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(103.6,102);
	...
	this.txt_price.setTransform(84.3,313);
	...
	this.shape_1.setTransform(84.5,281.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(247,243,230,0.698)").s().p("AtCD6IAAnzIaFAAIAAHzg");
	this.shape_2.setTransform(84.5,281.5);
...
(lib.Mc_buyKeySelect2 = function(mode,startPosition,loop) {
	...
	this.txt_top_key.lineWidth = 44;
	this.txt_top_key.parent = this;
	this.txt_top_key.setTransform(104.2,84);
	...
	this.shape.setTransform(84.5,281.5);
...
}).prototype = getMCSymbolPrototype(lib.Mc_buyKeySelect2, new cjs.Rectangle(0,0,169,333.5), null);
...
(lib.Mc_buyKeySelect1 = function(mode,startPosition,loop) {
	...
	this.txt_title.parent = this;
	this.txt_title.setTransform(84.3,3);
...
}).prototype = getMCSymbolPrototype(lib.Mc_buyKeySelect1, new cjs.Rectangle(0,0,169,333.5), null);
...
(lib.Mc_boxnkey = function(mode,startPosition,loop) {
	...
	this.txt_keys.parent = this;
	this.txt_keys.setTransform(322,45.3);
...
(lib.Btn_getKey = function(mode,startPosition,loop) {
	...
	this.txt.parent = this;
	this.txt.setTransform(83.3,14.4);
...
(lib.btn_start = function(mode,startPosition,loop) {
	...
	this.btn_text.setTransform(206.7,36);
...
(lib.btn_howtoplay = function(mode,startPosition,loop) {
	...
	this.btn_text.parent = this;
	this.btn_text.setTransform(81.4,2);
...
(lib.mc_sc2_bt = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(380,22.5);
...
(lib.OpenChestBoxItem = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.503,0.503);

	this.instance_1 = new lib.icon_back_2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,0,0.506,0.506);

	this.instance_2 = new lib.icon_back_3();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,0,0.506,0.506);

	this.instance_3 = new lib.icon_back_5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(0,0,0.506,0.506);

	this.instance_4 = new lib.icon_back_6();
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,0,0.506,0.506);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,77,88.6);
...
(lib.Mc_buyKeyError = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({scaleX:0.07,alpha:0.5},0).to({scaleX:1,alpha:1},5,cjs.Ease.circIn).wait(12));
...
(lib.mc_pagenation = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(38,96,161,0.251)").s().p("AgjAjQgOgPAAgUQAAgUAOgPQAPgOAUAAQAUAAAPAOQAPAPAAAUQAAAUgPAPQgPAPgUAAQgUAAgPgPg");
	this.shape_1.setTransform(5,5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(38,96,161,0.502)").s().p("AgjAjQgOgPAAgUQAAgUAOgPQAPgOAUAAQAUAAAPAOQAPAPAAAUQAAAUgPAPQgPAPgUAAQgUAAgPgPg");
	this.shape_2.setTransform(5,5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(38,96,161,0.749)").s().p("AgjAjQgOgPAAgUQAAgUAOgPQAPgOAUAAQAUAAAPAOQAPAPAAAUQAAAUgPAPQgPAPgUAAQgUAAgPgPg");
...
p.nominalBounds = new cjs.Rectangle(1.5,1,7,8.2);
...
(lib.Mc_page_no_container1 = function(mode,startPosition,loop) {
	...
	this.btn_page_no9.setTransform(110.2,2.5,1,1,0,0,0,3.5,3.5);
...
(lib.OpenPlayShineChestBox = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},6,cjs.Ease.cubicIn).wait(4).to({alpha:0.699},5,cjs.Ease.quadIn).to({alpha:1},5,cjs.Ease.quadOut).wait(4).to({alpha:0},6,cjs.Ease.cubicOut).wait(3));
...
(lib.Chestbox = function(mode,startPosition,loop) {
	...
	this.openChestBoxItem.setTransform(103,52.1,1,1,0,0,0,38.5,44.3);
	this.openChestBoxItem.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.openChestBoxItem).wait(9).to({scaleX:0.56,scaleY:0.56,x:103.1,y:99.1},0).to({regX:38.6,regY:44.4,scaleX:1.18,scaleY:1.18,x:103.2,y:52.2,alpha:1},4,cjs.Ease.quartIn).to({regX:38.5,regY:44.3,scaleX:1,scaleY:1,x:103,y:52.1},2,cjs.Ease.cubicOut).wait(11));
...
p.nominalBounds = new cjs.Rectangle(17,7.8,186,174.3);
...
(lib.Mc_getKeyCounter = function(mode,startPosition,loop) {
	...
	this.instance = new lib.key2();
	this.instance.parent = this;
	this.instance.setTransform(26,17,0.492,0.492);
	...
	this.txt_count_balance.setTransform(186,110.7);
	...
	this.btn_down.setTransform(239.1,75,1,1,0,0,0,24,25);
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#C6AA7A").ss(2,1,1).p("AM0nzIPoAAIAAPnIvoAAAFKnzIHgAAIAAHzAsznzIRzAAIAAHzIHqAAIAAH0IngAAAFAAAIAAH0IxzAAA8bnzIPoAAIAAPnIvoAAg");
	this.shape.setTransform(182,50);
	...
	this.shape_2.setTransform(157.1,50);
...
(lib.Mc_confirm = function(mode,startPosition,loop) {
	...
	this.keyContainer.setTransform(572.2,166.6,1,1,0,0,0,93.7,54.7);
	...
	this.keyPaper.setTransform(358,209.6,1,1,0,0,0,84,130.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({scaleX:0.07,alpha:0.5},0).to({scaleX:1,alpha:1},5,cjs.Ease.circIn).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-56,0,779,433);
...
(lib.Mc_captainPickSelecter = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({scaleX:0.07,alpha:0.5},0).to({scaleX:1,alpha:1},5,cjs.Ease.circIn).wait(7));
...
p.nominalBounds = new cjs.Rectangle(0,0,706.5,333.5);
...
(lib.btn_backtogame = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(31.7,21.1,0.827,0.827,0,0,0,13,13);
...
(lib.sc_start = function(mode,startPosition,loop) {
	...
	this.btn_howtoplay.setTransform(380.2,594.5,1,1,0,0,0,75.2,11.5);
	this.btn_howtoplay.alpha = 0;
	new cjs.ButtonHelper(this.btn_howtoplay, 0, 1, 2, false, new lib.btn_howtoplay(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn_howtoplay).wait(43).to({y:606.5},0).to({y:594.5,alpha:1},8,cjs.Ease.cubicIn).wait(1));
	...
	this.btn_mychest.setTransform(99.1,594,1,1,0,0,0,85,20);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(27).to({scaleX:0.65,scaleY:0.65},0).to({scaleX:1,scaleY:1,alpha:1},11,cjs.Ease.bounceOut).wait(14));

	// mc_title
	this.mc_title = new lib.mc_title();
	this.mc_title.name = "mc_title";
	this.mc_title.parent = this;
	this.mc_title.setTransform(379.9,307.4,1,1,0,0,0,163.7,24.5);
	this.mc_title.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.mc_title).wait(32).to({alpha:1},11,cjs.Ease.bounceOut).wait(9));

	// btn_start
	this.btn_start = new lib.btn_start();
	this.btn_start.name = "btn_start";
	this.btn_start.parent = this;
	this.btn_start.setTransform(379.7,382.6,0.797,0.798,0,0,0,204.2,57.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(5).to({alpha:1},12,cjs.Ease.quadIn).to({alpha:0.82},2,cjs.Ease.quadOut).to({alpha:1},2,cjs.Ease.quadIn).wait(31));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,760,625);
...
(lib.Mc_itemTable = function(mode,startPosition,loop) {
	...
	this.frame_1 = function() {
		this.stop();
		$("#normalItemTable").css({top:-2000,left:aniLeft.left});
	}
...
p.nominalBounds = new cjs.Rectangle(0,-2,760,505);
...
(lib.Mc_invenContainer = function(mode,startPosition,loop) {
	...
	this.frame_1 = function() {
		this.stop();
		$("#inventory").css({top:-2000,left:aniLeft.left+inventoryLeftMargin});
	}
	this.frame_2 = function() {
...
(lib.Mc_buyKeyContainer = function(mode,startPosition,loop) {
	...
	this.mc_balance.setTransform(701.7,86,1,1,0,0,0,83.5,12);
...
p.nominalBounds = new cjs.Rectangle(-33,-2,793.5,506);
...
(lib.Mc_result_bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(367.6,172,0.999,1,0,0,0,367.8,172);
...
(lib.MC_openchetbox_5 = function(mode,startPosition,loop) {
	...
	var mask_graphics_1 = new cjs.Graphics().p("EgpKAAgIAAg/MBSVAAAIAAA/g");
	var mask_graphics_2 = new cjs.Graphics().p("EgpKAAnIAAhNMBSVAAAIAABNg");
	var mask_graphics_3 = new cjs.Graphics().p("EgpKAAzIAAhlMBSVAAAIAABlg");
	var mask_graphics_4 = new cjs.Graphics().p("EgpKABEIAAiIMBSVAAAIAACIg");
	var mask_graphics_5 = new cjs.Graphics().p("EgpKABaIAAi0MBSVAAAIAAC0g");
	var mask_graphics_6 = new cjs.Graphics().p("EgpKAB1IAAjqMBSVAAAIAADqg");
	var mask_graphics_7 = new cjs.Graphics().p("EgpKACVIAAkpMBSVAAAIAAEpg");
	var mask_graphics_8 = new cjs.Graphics().p("EgpKAC6IAAlzMBSVAAAIAAFzg");
	var mask_graphics_9 = new cjs.Graphics().p("EgpKADkIAAnHMBSVAAAIAAHHg");
	var mask_graphics_10 = new cjs.Graphics().p("EgpKAESIAAojMBSVAAAIAAIjg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:378.5,y:294.9}).wait(1).to({graphics:mask_graphics_1,x:378.5,y:294.7}).wait(1).to({graphics:mask_graphics_2,x:378.5,y:294}).wait(1).to({graphics:mask_graphics_3,x:378.5,y:292.7}).wait(1).to({graphics:mask_graphics_4,x:378.5,y:291}).wait(1).to({graphics:mask_graphics_5,x:378.5,y:288.8}).wait(1).to({graphics:mask_graphics_6,x:378.5,y:286.1}).wait(1).to({graphics:mask_graphics_7,x:378.5,y:282.9}).wait(1).to({graphics:mask_graphics_8,x:378.5,y:279.3}).wait(1).to({graphics:mask_graphics_9,x:378.5,y:275.1}).wait(1).to({graphics:mask_graphics_10,x:378.5,y:270.4}).wait(11));
	...
	this.chestBox4.setTransform(467,201.6,1,1,0,0,0,110,94.9);
	this.chestBox4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox4).wait(9).to({y:203.6},0).to({y:193.6,alpha:1},6,cjs.Ease.quintIn).to({y:201.6},2,cjs.Ease.quintOut).wait(4));

	// Layer_18 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("EgyxAAUIAAgnMBljAAAIAAAng");
	var mask_1_graphics_1 = new cjs.Graphics().p("EgyxAAYIAAgvMBljAAAIAAAvg");
	var mask_1_graphics_2 = new cjs.Graphics().p("EgyxAAkIAAhHMBljAAAIAABHg");
	var mask_1_graphics_3 = new cjs.Graphics().p("EgyxAA4IAAhvMBljAAAIAABvg");
	var mask_1_graphics_4 = new cjs.Graphics().p("EgyxABVIAAipMBljAAAIAACpg");
	var mask_1_graphics_5 = new cjs.Graphics().p("EgyxAB5IAAjxMBljAAAIAADxg");
	var mask_1_graphics_6 = new cjs.Graphics().p("EgyxACmIAAlLMBljAAAIAAFLg");
	var mask_1_graphics_7 = new cjs.Graphics().p("EgyxADaIAAmzMBljAAAIAAGzg");
	var mask_1_graphics_8 = new cjs.Graphics().p("EgyxAEXIAAotMBljAAAIAAItg");
	var mask_1_graphics_9 = new cjs.Graphics().p("EgyxAFcIAAq3MBljAAAIAAK3g");
	var mask_1_graphics_10 = new cjs.Graphics().p("EgyxAGpIAAtRMBljAAAIAANRg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:383,y:198.9}).wait(1).to({graphics:mask_1_graphics_1,x:383,y:198.5}).wait(1).to({graphics:mask_1_graphics_2,x:383,y:197.3}).wait(1).to({graphics:mask_1_graphics_3,x:383,y:195.3}).wait(1).to({graphics:mask_1_graphics_4,x:383,y:192.4}).wait(1).to({graphics:mask_1_graphics_5,x:383,y:188.8}).wait(1).to({graphics:mask_1_graphics_6,x:383,y:184.3}).wait(1).to({graphics:mask_1_graphics_7,x:383,y:179.1}).wait(1).to({graphics:mask_1_graphics_8,x:383,y:173}).wait(1).to({graphics:mask_1_graphics_9,x:383,y:166.1}).wait(1).to({graphics:mask_1_graphics_10,x:383,y:158.4}).wait(11));
	...
	this.chestBox0.setTransform(225,90.2,1,1,0,0,0,110,94.9);
	this.chestBox0.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox0).wait(6).to({y:92.2},0).to({y:82.2,alpha:1},6,cjs.Ease.quintIn).to({y:90.2},2,cjs.Ease.quintOut).wait(7));

	// chestBox1
	this.chestBox1 = new lib.Chestbox();
	this.chestBox1.name = "chestBox1";
	this.chestBox1.parent = this;
	this.chestBox1.setTransform(390,93.2,1,1,0,0,0,110,94.9);
	this.chestBox1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox1).wait(9).to({y:95.2},0).to({y:85.2,alpha:1},6,cjs.Ease.quintIn).to({y:93.2},2,cjs.Ease.quintOut).wait(4));

	// chestBox2
	this.chestBox2 = new lib.Chestbox();
	this.chestBox2.name = "chestBox2";
	this.chestBox2.parent = this;
	this.chestBox2.setTransform(555,92.2,1,1,0,0,0,110,94.9);
	this.chestBox2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox2).wait(12).to({y:94.2},0).to({y:84.2,alpha:1},6,cjs.Ease.quintIn).to({y:92.2},2,cjs.Ease.quintOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(124,3,524,289);
...
(lib.MC_openchestbox_10 = function(mode,startPosition,loop) {
	...
	var mask_graphics_3 = new cjs.Graphics().p("Eg8JAAnIAAhNMB4TAAAIAABNg");
	var mask_graphics_4 = new cjs.Graphics().p("Eg8JAA2IAAhrMB4TAAAIAABrg");
	var mask_graphics_5 = new cjs.Graphics().p("Eg8JABOIAAibMB4TAAAIAACbg");
	var mask_graphics_6 = new cjs.Graphics().p("Eg8JABwIAAjfMB4TAAAIAADfg");
	var mask_graphics_7 = new cjs.Graphics().p("Eg8JACbIAAk1MB4TAAAIAAE1g");
	var mask_graphics_8 = new cjs.Graphics().p("Eg8JADQIAAmfMB4TAAAIAAGfg");
	var mask_graphics_9 = new cjs.Graphics().p("Eg8JAEPIAAodMB4TAAAIAAIdg");
	var mask_graphics_10 = new cjs.Graphics().p("Eg8JAFXIAAqtMB4TAAAIAAKtg");
	var mask_graphics_11 = new cjs.Graphics().p("Eg8JAGpIAAtRMB4TAAAIAANRg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:382.1,y:315.5}).wait(2).to({graphics:mask_graphics_2,x:382.1,y:315.5}).wait(1).to({graphics:mask_graphics_3,x:382.1,y:315}).wait(1).to({graphics:mask_graphics_4,x:382.1,y:313.6}).wait(1).to({graphics:mask_graphics_5,x:382.1,y:311.2}).wait(1).to({graphics:mask_graphics_6,x:382.1,y:307.8}).wait(1).to({graphics:mask_graphics_7,x:382.1,y:303.5}).wait(1).to({graphics:mask_graphics_8,x:382.1,y:298.1}).wait(1).to({graphics:mask_graphics_9,x:382.1,y:291.8}).wait(1).to({graphics:mask_graphics_10,x:382.1,y:284.6}).wait(1).to({graphics:mask_graphics_11,x:382.1,y:276.4}).wait(14));

	// Layer_9
	this.instance = new lib.sandrow2();
	this.instance.parent = this;
	this.instance.setTransform(2,249,1.192,1);
	...
	this.chestBox5.setTransform(115.1,210.6,1,1,0,0,0,110,94.9);
	this.chestBox5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox5).wait(12).to({y:217.6},0).to({y:195.6,alpha:1},6,cjs.Ease.quintIn).to({y:210.6},3,cjs.Ease.quintOut).wait(4));

	// chestBox6
	this.chestBox6 = new lib.Chestbox();
	this.chestBox6.name = "chestBox6";
	this.chestBox6.parent = this;
	this.chestBox6.setTransform(246.5,212.6,1,1,0,0,0,110,94.9);
	this.chestBox6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox6).wait(9).to({y:219.6},0).to({y:197.6,alpha:1},6,cjs.Ease.quintIn).to({y:212.6},3,cjs.Ease.quintOut).wait(7));

	// chestBox7
	this.chestBox7 = new lib.Chestbox();
	this.chestBox7.name = "chestBox7";
	this.chestBox7.parent = this;
	this.chestBox7.setTransform(386,203.6,1,1,0,0,0,110,94.9);
	this.chestBox7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox7).wait(6).to({y:210.6},0).to({y:188.6,alpha:1},6,cjs.Ease.quintIn).to({y:203.6},3,cjs.Ease.quintOut).wait(10));

	// chestBox8
	this.chestBox8 = new lib.Chestbox();
	this.chestBox8.name = "chestBox8";
	this.chestBox8.parent = this;
	this.chestBox8.setTransform(527.4,211.6,1,1,0,0,0,110,94.9);
	this.chestBox8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox8).wait(9).to({y:218.6},0).to({y:196.6,alpha:1},6,cjs.Ease.quintIn).to({y:211.6},3,cjs.Ease.quintOut).wait(7));

	// chestBox9
	this.chestBox9 = new lib.Chestbox();
	this.chestBox9.name = "chestBox9";
	this.chestBox9.parent = this;
	this.chestBox9.setTransform(659,208.6,1,1,0,0,0,110,94.9);
	this.chestBox9.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox9).wait(12).to({y:215.6},0).to({y:193.6,alpha:1},6,cjs.Ease.quintIn).to({y:208.6},3,cjs.Ease.quintOut).wait(4));
	...
	var mask_1_graphics_4 = new cjs.Graphics().p("Eg7NAAZIAAgxMB2bAAAIAAAxg");
	var mask_1_graphics_5 = new cjs.Graphics().p("Eg7NAAoIAAhPMB2bAAAIAABPg");
	var mask_1_graphics_6 = new cjs.Graphics().p("Eg7NABBIAAiBMB2bAAAIAACBg");
	var mask_1_graphics_7 = new cjs.Graphics().p("Eg7NABkIAAjHMB2bAAAIAADHg");
	var mask_1_graphics_8 = new cjs.Graphics().p("Eg7NACRIAAkhMB2bAAAIAAEhg");
	var mask_1_graphics_9 = new cjs.Graphics().p("Eg7NADIIAAmPMB2bAAAIAAGPg");
	var mask_1_graphics_10 = new cjs.Graphics().p("Eg7NAEJIAAoRMB2bAAAIAAIRg");
	var mask_1_graphics_11 = new cjs.Graphics().p("Eg7NAFUIAAqnMB2bAAAIAAKng");
	var mask_1_graphics_12 = new cjs.Graphics().p("Eg7NAGpIAAtRMB2bAAAIAANRg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:383,y:198.9}).wait(3).to({graphics:mask_1_graphics_3,x:383,y:198.9}).wait(1).to({graphics:mask_1_graphics_4,x:383,y:198.4}).wait(1).to({graphics:mask_1_graphics_5,x:383,y:196.9}).wait(1).to({graphics:mask_1_graphics_6,x:383,y:194.4}).wait(1).to({graphics:mask_1_graphics_7,x:383,y:190.9}).wait(1).to({graphics:mask_1_graphics_8,x:383,y:186.4}).wait(1).to({graphics:mask_1_graphics_9,x:383,y:180.9}).wait(1).to({graphics:mask_1_graphics_10,x:383,y:174.4}).wait(1).to({graphics:mask_1_graphics_11,x:383,y:166.9}).wait(1).to({graphics:mask_1_graphics_12,x:383,y:158.4}).wait(13));

	// Layer_9
	this.instance_1 = new lib.sandrow2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(4,129,1.186,1);
	...
	this.chestBox0.name = "chestBox0";
	this.chestBox0.parent = this;
	this.chestBox0.setTransform(118.1,90.2,1,1,0,0,0,110,94.9);
	this.chestBox0.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox0).wait(15).to({y:95.2},0).to({y:81.2,alpha:1},6,cjs.Ease.quintIn).to({y:90.2},3,cjs.Ease.quintOut).wait(1));

	// chestBox1
	this.chestBox1 = new lib.Chestbox();
	this.chestBox1.name = "chestBox1";
	this.chestBox1.parent = this;
	this.chestBox1.setTransform(256.5,90.2,1,1,0,0,0,110,94.9);
	this.chestBox1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox1).wait(12).to({y:95.2},0).to({y:81.2,alpha:1},6,cjs.Ease.quintIn).to({y:90.2},3,cjs.Ease.quintOut).wait(4));

	// chestBox2
	this.chestBox2 = new lib.Chestbox();
	this.chestBox2.name = "chestBox2";
	this.chestBox2.parent = this;
	this.chestBox2.setTransform(389,88.2,1,1,0,0,0,110,94.9);
	this.chestBox2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox2).wait(9).to({y:93.2},0).to({y:79.2,alpha:1},6,cjs.Ease.quintIn).to({y:88.2},3,cjs.Ease.quintOut).wait(7));

	// chestBox3
	this.chestBox3 = new lib.Chestbox();
	this.chestBox3.name = "chestBox3";
	this.chestBox3.parent = this;
	this.chestBox3.setTransform(525.4,93.2,1,1,0,0,0,110,94.9);
	this.chestBox3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox3).wait(12).to({y:98.2},0).to({y:84.2,alpha:1},6,cjs.Ease.quintIn).to({y:93.2},3,cjs.Ease.quintOut).wait(4));

	// chestBox4
	this.chestBox4 = new lib.Chestbox();
	this.chestBox4.name = "chestBox4";
	this.chestBox4.parent = this;
	this.chestBox4.setTransform(663,88.2,1,1,0,0,0,110,94.9);
	this.chestBox4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.chestBox4).wait(15).to({y:93.2},0).to({y:79.2,alpha:1},6,cjs.Ease.quintIn).to({y:88.2},3,cjs.Ease.quintOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(22.1,1,734,298.7);
...
(lib.MC_openbox_result = function(mode,startPosition,loop) {
	...
	this.result_arrows.setTransform(381,246.6,1,1,0,0,0,377,22);
	...
	this.pageNumCont.setTransform(382.2,398.2,1,1,0,0,0,23,8.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.resultCont10).wait(4).to({alpha:1},6,cjs.Ease.quartOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.resultCont5).wait(4).to({alpha:1},6,cjs.Ease.quartOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,-2,7575,500);
...
(lib.sc_open_chest = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_title).wait(17).to({y:9.1},0).to({y:20.1,alpha:1},9,cjs.Ease.cubicIn).wait(8));
	...
	this.mc_bt.name = "mc_bt";
	this.mc_bt.parent = this;
	this.mc_bt.setTransform(381,602.5,1,1,0,0,0,379.9,22.5);
	this.mc_bt.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_sc1_bg).wait(2).to({alpha:0.488},0).to({alpha:1},7,cjs.Ease.cubicIn).wait(25));
...
(lib.uwo_gacha_game = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		...
		function getSingleResultItems(mc, id) {
			...
			$.ajax({
				type: 'GET',
				url: 'assets/images/uwo/gacha/data/GetChestBoxItem_' + ChestBoxSelectNo + '.json',
				dataType: 'json',
				success: function (data) {
					var code = data.ResultCode[0].Code;
					if (code === "10000") {
						isOpenedChest=false;
						items = data.GachaItemList;
						if (ChestBoxSelectNo == 1) {
		...
		function OpenedResultData(arr, id) {
			...
			if (ChestBoxSelectNo === 1) {
				...
				leftSection.txt_ctg.text = arr[id].Category.toUpperCase();
				...
				for (var i in arr) {
					...
					leftSection.txt_ctg.text = arr[i].Category.toUpperCase();
		...
		function gotKeyOpen(e){
			if(!isBuyKeyBoxOpened){
				...
				root.sc1.buyKeyContainer.mc_title.btn_back.addEventListener("click", function (event) {
					console.log(root.isBuyLabelFlag)
					...
					mc.addEventListener("click",function(event){
						...
						if(id==='3'){
							...
							root.sc1.buyKeyContainer.buyKeyCounter.buyKeyStepper.btn_up.addEventListener("click",function(event){
								...
								calcBalance=keyCounter*EACH_KEY_VALUE;
								root.sc1.buyKeyContainer.buyKeyCounter.buyKeyStepper.txt_count_no.text=keyCounter;
								root.sc1.buyKeyContainer.buyKeyCounter.buyKeyStepper.txt_count_balance.text=calcBalance+" UWC";
							});
	...
	this.instance.parent = this;
	this.instance.setTransform(-474.4,221.1,1,1,0,0,0,110,94.9);

	this.instance_1 = new lib.mc_icon_back();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-458.4,-0.9);
	...
	this.sc1.setTransform(80.1,80.1,1,1,0,0,0,80,80);

	this.timeline.addTween(cjs.Tween.get(this.sc1).wait(50));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-187.5,311.6,8142.5,629);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"assets/images/uwo/gacha/uwo_gacha_game_atlas_.png", id:"uwo_gacha_game_atlas_"}
	],
	preloads: []
};
